package com.example.plush81029.customviewtest.titlebar;
...
public class TitleBarView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {
    ...
    public void setTileBarBackgroundColor(int color) {
        if (rlView != null) {
            rlView.setBackgroundColor(color);
        }
    }
    public void setTileBarBackgroundDrawale(Drawable drawale) {
        if (rlView != null) {
            rlView.setBackground(drawale);
        }
    }
    public void setTileBarBackgroundDResouce(int res) {
        if (rlView != null) {
            rlView.setBackgroundResource(res);
        }
    }
